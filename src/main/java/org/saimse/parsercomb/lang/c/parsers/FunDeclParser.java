...
import org.saimse.parsercomb.lang.c.statements.FunDecl;
...
public class FunDeclParser implements Parser<FunDecl> {
    @Override
    public Pair<String, FunDecl> parse(String input) throws BadParseException {
        ...
        Pair<String, Statement> body = new StatementParser().parse(params.a);
